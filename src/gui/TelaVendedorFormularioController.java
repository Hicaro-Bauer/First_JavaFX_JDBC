...
public class TelaVendedorFormularioController implements Initializable {
	...
	public void onBtSaveAction(ActionEvent event) {
		...
		try {
			...
			if (txtId.getText().isEmpty()) {
				Alerts.showAlert("Sucesso!", null, "Departamento cadastrado com sucesso!!", AlertType.INFORMATION);
			} else {
				Alerts.showAlert("Sucesso!", null, "Departamento atualizado com sucesso!!", AlertType.INFORMATION);
			}
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldMaxLength(txtEmail, 65);
	...
	public void updateFormData() {
		...
		if (entity.getBirthDate() != null) {
			LocalDateTime data = LocalDateTime.ofInstant(entity.getBirthDate().toInstant(), ZoneId.systemDefault());
